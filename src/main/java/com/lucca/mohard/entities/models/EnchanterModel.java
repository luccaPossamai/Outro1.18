...
public class EnchanterModel<T extends AbstractIllager> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public EnchanterModel(ModelPart p_170688_) {
        this.cape = p_170688_.getChild("cape");
        this.book = p_170688_.getChild("arms").getChild("book");
        this.root = p_170688_;
        ...
        /*
        this.book = new ModelPart(this).setTexSize(p_i47227_3_, p_i47227_4_);
        this.book.texOffs(26, 70).addBox(-3.0F, 3.0F, -7.0F, 6.0F, 2.0F, 10.0F, p_i47227_1_);
        ModelPart page = (new ModelPart(this)).setTexSize(p_i47227_3_, p_i47227_4_);
        page.texOffs(26, 83).addBox(-3.0F, 3.0F, -6.0F, 5.0F, 2.0F, 8.0F, p_i47227_1_);
        page.visible = true;
        this.book.addChild(page);
        ...
        this.cape = (new ModelPart(this)).setTexSize(p_i47227_3_, p_i47227_4_);
        this.cape.texOffs(0, 70).addBox(-4F, 0F, 3.0F, 8.0F, 23F, 1,p_i47227_1_);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition1.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -16.0F, -4.0F, 8.0F, 12.0F, 8.0F, new CubeDeformation(0.45F)), PartPose.ZERO);
        ...
        partdefinition2.addOrReplaceChild("book", CubeListBuilder.create().texOffs(26, 70).addBox(-3.0F, 3.0F, -7.0F, 6.0F, 2.0F, 10.0F).texOffs(26, 83).addBox(-3.0F, 3.0F, -6.0F, 5.0F, 2.0F, 8.0F), PartPose.ZERO);
        partdefinition.addOrReplaceChild("cape", CubeListBuilder.create().texOffs(0, 70).addBox(-4F, 0F, 3.0F, 8.0F, 23F, 1), PartPose.ZERO);
    ...
    public static void bobModel(ModelPart p_239101_0_, float p_239101_2_) {
        p_239101_0_.xRot += Mth.sin(p_239101_2_ * 0.067F) * 0.05F;
    }
    ...
    public void setupAnim(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        ...
        float rot = Mth.cos(p_225597_2_ * 0.6662F) * 2.0F * p_225597_3_ * 0.5F;
        if(rot < 0){
            rot = rot / 10;
        }
        this.cape.xRot = 0.1F + rot;
        bobModel(this.cape, p_225597_4_);
        if (this.riding) {
