...
public class Creepy extends Monster implements PowerableMob {

    private static final EntityDataAccessor<Integer> DATA_SWELL_DIR = SynchedEntityData.defineId(Creepy.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> DATA_IS_POWERED = SynchedEntityData.defineId(Creepy.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> DATA_IS_IGNITED = SynchedEntityData.defineId(Creepy.class, EntityDataSerializers.BOOLEAN);
    ...
    public Creepy(EntityType<? extends Creepy> p_32278_, Level p_32279_) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(ModAttributes.PHYSICAL_DAMAGE.get(), 10)
    ...
    protected void dropCustomDeathLoot(DamageSource p_32292_, int p_32293_, boolean p_32294_) {
        ...
        if (entity != this && entity instanceof Creepy) {
    ...
    private void spawnLingeringCloud() {
        ...
        collection.add(new MobEffectInstance(ModEffects.CORRUPTION.get(),10));
    ...
    public class SwellGoal extends Goal {
        ...
        public SwellGoal(Creepy p_25919_) {
