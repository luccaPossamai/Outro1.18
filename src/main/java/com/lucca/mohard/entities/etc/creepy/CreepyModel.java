...
@OnlyIn(Dist.CLIENT)
public class CreepyModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public CreepyModel(ModelPart p_170524_) {
        this.root = p_170524_;
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation p_170526_) {
        ...
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, p_170526_), PartPose.offset(0.0F, 14.0F, 0.0F));
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 8.0F, -2.0F, 8.0F, 4.0F, 4.0F, p_170526_), PartPose.offset(0.0F, 6.0F, 0.0F));
