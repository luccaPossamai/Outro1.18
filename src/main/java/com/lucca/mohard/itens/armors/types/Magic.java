...
public class Magic {
    ...
    private final int[] DEFENSE       = new int[]{2, 4, 5, 3};
    private final int DURABILITY_MULTIPLIER = 13;

    public final ArmorMaterial MAGIC = new ArmorMaterial() {
        ...
        public String getName() {
            return (ExampleMod.MOD_ID+":magic");
        }
